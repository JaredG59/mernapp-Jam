...
import { AppBar, Typography, Button, Avatar, Toolbar, Container } from '@material-ui/core';
    ...
    <AppBar className={classes.appBar} position="static" color="inherit" >
        ...
        <Toolbar className = {classes.toolbar} >
            ...
            <div className={classes.profile}>
                ...
                <Button variant="contained" position= "fixed" className={classes.logout} color="secondary" size="small"onClick={logout}>Logout</Button>
            </div>
            ) : (
